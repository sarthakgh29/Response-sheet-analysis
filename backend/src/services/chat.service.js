...
import { getSheet } from './sheet.service.js';
import { buildSurveySystemPrompt } from './prompt.service.js';

export async function answerSheetQuestion(sheetId, payload) {
  ...
  const systemPrompt = buildSurveySystemPrompt(
    sheetData.analysis,
    sheetData.sheet.fileName
  );
